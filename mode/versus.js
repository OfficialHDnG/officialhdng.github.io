////////////////////////////////////////////////////////////////
///   Black NotePad - 4/28/2022 6:51:38 PM - Not activated   ///
////////////////////////////////////////////////////////////////
'use strict';
				...
				if(_status.mode=='guandu'){
					...
					if(lib.storage.single_control){
						...
						if(game.players.length>2&&lib.config.show_handcardbutton){
							ui.versushs=ui.create.system('Set',null,true);
							lib.setPopped(ui.versushs,game.versusHoverHandcards,220);
						}
					}
			...
			chooseCharacter:function(){
				...
				next.setContent(function(){
					...
					if(((position==Math.ceil(num/2)-1&&lib.storage.zhu)||(lib.storage.zhu&&lib.storage.single_control))){
						var dialog=ui.create.dialog('Lead With',[_status.friend,'character']);
			...
			phaseLoopThree:function(player){
				...
				next.setContent(function(){
					...
					if(swap.length==1){
						...
						var next=target.chooseTarget('Lead',true,function(card,player,target2){
				...
				next.setContent(function(){
					...
					if(lib.storage.zhu){
						...
						if(list.length==0) event.redo();
							...
							game.me.chooseTarget('Choose Leader',true,function(card,player,target){
